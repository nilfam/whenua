# Generated by Django 2.0.4 on 2020-10-10 21:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'Short Text'), (1, 'Long Text'), (2, 'Date'), (3, 'Integer'), (4, 'Float'), (6, 'Boolean'), (7, 'Base64 Png'), (8, 'Waveform'), (9, 'Sequence'), (10, 'Url'), (11, 'Image')])),
            ],
        ),
        migrations.CreateModel(
            name='ExtraAttrValue',
            fields=[
                ...
                ('value', models.TextField()),
                ('attr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='root.ExtraAttr')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['owner_id'], name='root_extraa_owner_i_0c4a1b_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='extraattrvalue',
