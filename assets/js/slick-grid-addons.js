...
const LongTextEditorRewritten = function (args) {
    var $input, $wrapper;
    var defaultValue;
    var scope = this;
    ...
    this.init = function () {
      ...
      $input = $("<TEXTAREA hidefocus rows=5 style='background:white;width:350px;height:400px;border:0;outline:0'>")
          .appendTo($wrapper);
...
SlickEditors.LongText = LongTextEditorRewritten;
