                ...
                <FormGroup>
                    ...
                    <Col sm={8}>
                        <Dropdown
                            ...
                            itemKey="channels" selectedKey="channel"
                ...
                <FormGroup>
                    ...
                    <Col sm={8}>
                        <Dropdown
                            ...
                            itemKey="colourMaps" selectedKey="colourMap"
                ...
                <FormGroup>
                    ...
                    <Col sm={8}>
                        <Dropdown
                            ...
                            itemKey="zooms" selectedKey="zoom"
...
export default class SpectrogramControlButton extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <button id="spectrogram-control-btn" type="button"
                ...
                <Modal show={this.state.show} onHide={this.handleClose}>
                    ...
                    <Modal.Body>
                        <SpectrogramControlForm onSuccess={this.handleSuccess} onFailure={this.handleFailure}
                                                nChannels={this.nChannels} spectViz={this.spectViz} zoom={this.zoom} colourMap={this.colourMap}/>
                    </Modal.Body>
                    <Modal.Footer>
                        <div className="btn-group btn-group-justified" role="group" aria-label="group button">
                            <div className="btn-group" role="group">
                                <button type="submit" id="dialog-modal-yes-button"
                                        ...
                                        role="button" form='spectrogramControlForm'>
                                    Confirm
                                </button>
                            </div>
